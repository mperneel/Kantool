...
class NewProject(tk.Toplevel):
    ...
    self.master : Application
        Master object which invokes newProject
    ...
    self.img_skeleton : tkinter.StringVar
        Image to create a new skeleton

    self.dir_skeleton : tkinter.StringVar
        Directory of skeleton to import

    self.img_skeleton_bool : tkinter.BooleanVar
        Boolean indicating if the user wants to create a new skeleton

    self.dir_skeleton_bool : tkinter.BooleanVar
        Boolean indicating if the user wants to import a skeleton
    ...
    self.check_img_skeleton
        Check if a valid image was given

    self.check_dir_skeleton
